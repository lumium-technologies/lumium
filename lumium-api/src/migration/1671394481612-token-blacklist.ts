...
export class tokenBlacklist1671394481612 implements MigrationInterface {
    name = 'tokenBlacklist1671394481612'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "authentication_information" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "version" integer NOT NULL DEFAULT '0', "key" character varying NOT NULL, CONSTRAINT "PK_591fa49b4252c7efee4b65077a1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "blacklisted_tokens" ADD CONSTRAINT "FK_fc690bef555ae373813789f3c4b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
